"""
From https://github.com/cmbruns/pyopenxr_examples/blob/main/xr_examples/track_hmd.py
"""
...
with (
    xr.utils.gl.glfw_util.InstanceObject(application_name="track_hmd") as instance,
    xr.utils.gl.glfw_util.SystemObject(instance) as system,
    xr.utils.gl.glfw_util.GlfwWindow(system) as window,
    xr.utils.gl.glfw_util.SessionObject(
